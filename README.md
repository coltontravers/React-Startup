This allows you to quickly setup a React project with all you need but not necessarily all you want. The master branch should be a simple, modern setup for starting your React app.
